...
import (
	...
	"react-todos/apps/api/internal/infrastructure/utils"

	"github.com/go-chi/chi/v5"
	"github.com/google/uuid"
)

// TodoHandler holds the dependencies for all todo-related endpoints.
type TodoHandler struct {
	service services.TodoServicer
}

// NewTodoHandler constructs a TodoHandler.
func NewTodoHandler(service services.TodoServicer) *TodoHandler {
...
func (h *TodoHandler) GetTodos(w http.ResponseWriter, r *http.Request) {
	...
	todos, total, err := h.service.GetAll(r.Context(), userID, limit, offset, sortBy, sortOrder, filterCompleted, filterAssigned)
	if err != nil {
